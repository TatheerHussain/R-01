...
| Coding Type | Precision | Recall | F-measure | Support |
|-------------|----------:|:------:|----------:|--------:|
| IDNUM | 0.9973357 | 0.9541206 | 0.9752496 | 1177 |
| DOCTOR | 0.9862408 | 0.9160201 | 0.9498343 | 2191 |
| MEDICALRECORD | 0.9982206 | 0.9964476 | 0.9973333 | 563 |
| PATIENT | 0.9981238 | 0.9761468 | 0.987013 | 545 |
| HOSPITAL | 0.9831081 | 0.9814503 | 0.9822785 | 593 |
| DATE | 0.9954984 | 0.9579208 | 0.9763482 | 1616 |
| TIME | 0.9924433 | 0.9425837 | 0.9668711 | 418 |
| CITY | 0.9969231 | 0.9614244 | 0.978852 | 337 |
| STREET | 0.996875 | 0.9937695 | 0.9953198 | 321 |
| ZIP | 1 | 0.9846154 | 0.9922481 | 325 |
| STATE | 1 | 0.9741936 | 0.9869281 | 310 |
| DEPARTMENT | 0.9916434 | 0.9726776 | 0.982069 | 366 |
| ORGANIZATION | 1 | 0.9166667 | 0.9565217 | 24 |
| AGE | 0.9824561 | 0.9824561 | 0.9824561 | 57 |
| DURATION | 0.75 | 1 | 0.8571429 | 6 |
| PHONE | 1 | 1 | 1 | 2 |
| COUNTRY | 1 | 1 | 1 | 2 |
| LOCATION-OTHER | 1 | 1 | 1 | 4 |
| Micro-avg. F| 0.9928412 | 0.9551767 | 0.9736449 | 8857 |
| Macro-avg. F| 0.9816039 | 0.9728053 | 0.9771848 | 8857 |
|-------------|----------:|:------:|----------:|----------:|
|-------------|----------:|:------:|----------:|----------:|
| Temporal Type | Precision | Recall | F-measure | Support |
|-------------|----------:|:------:|----------:|----------:|
...
| TIME | 0.9949238 | 0.937799 | 0.9655172 | 418 |
| DURATION | 1 | 1 | 1 | 6 |
| Micro-avg.| 0.9055442 | 0.8647059 | 0.884654 | 2040 |
| Macro-avg.| 0.9591176 | 0.9276987 | 0.9431465 | 2040 |
|-------------|----------:|:------:|----------:|----------:|
...
* DEPARTMENT   
    ...
    * 加入2部分字典 : 0.982069
* CITY  
    * 依賴STATE_Finder 查找同行 取 CITY        
* ZIP           
* STREET        
* STATE         
* AGE 
    * 錯誤都是標註者漏標
    * case 'M / 76 Slides of' pass            
* ORGANIZATION  
* DURATION      
    * 0.8307692 很難提升 答案標註有問題
    * 有的時間亂標 也有漏標
* PHONE         
* URL
    * 資料少 又亂標 網址格式不對 
